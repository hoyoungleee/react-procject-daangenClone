...
import ImageCarousel from '../../components/jinho/ImageCarousel';
import SellerInfo from '../../components/jinho/SellerInfo';
...
const products = [
  {
    ...
    sellerOtherProducts: [
      { image: Img1, title: "이케아 벽선반(Burhult) 3개", price: "11,000원", location: "서초동" },
      { image: Img2, title: "이케아 벽선반(Burhult) 3개", price: "11,000원", location: "서초동" },
      { image: otherImg1, title: "레고 해적 70410", price: "80,000원", location: "부암동" },
      { image: otherImg1, title: "레고 해적 70410", price: "80,000원", location: "서초동" },
      { image: otherImg2, title: "레고 6242 해적, 정부군 ...", price: "150,000원", location: "부암동" },
      { image: otherImg2, title: "레고 6242 해적, 정부군 ...", price: "150,000원", location: "서초동" },
    ],
    category: "가구/인테리어",
    timeAgo: "끌올 3분 전",
    price: "11,000원",
    ...
    popularListings: [
      { image: popImg1, title: "에어팟 프로2 c타입 4/7 구매품", price: "150,000원", location: "반포 4동" },
      { image: popImg2, title: "크르루제 오발 냄비", price: "100,000원", location: "방배 3동" },
      { image: popImg3, title: "마쥬 양가죽 자켓", price: "가격 없음", location: "서초 4동" },
      { image: popImg4, title: "<좌타용>랩골프 L.A.B. GOLF MEZZ.1 MAX 퍼터", price: "550,000원", location: "서초 1동" },
      { image: popImg5, title: "위닉스 보송 제습기, 필터새것", price: "370,000원", location: "서초동" },
      { image: popImg6, title: "락앤락진공쌀통", price: "10,000원", location: "양재동동" },
      { image: popImg7, title: "대림 대용량 제습기13L", price: "65,000원", location: "서초 2동" },
      { image: popImg8, title: "LG 벽걸이 에어컨 실외기 포함", price: "50,000원", location: "방배4동" },
      { image: popImg9, title: "등산배낭 백팽", price: "10,000원", location: "반포 1동" },
      { image: popImg10, title: "천마차 23봉", price: "1,000원", location: "방배 1동" },
      { image: popImg11, title: "흔한남매 10~18권 불꽃튀는 우리말과 오해요", price: "35,000원", location: "서초3동" },
      { image: popImg12, title: "아식스 운동화", price: "30,000원", location: "방배본동" },
      { image: popImg13, title: "옷장 정리합니다.", price: "555,5555원", location: "서초동" },
      { image: popImg14, title: "용선생 시끌벅적 과학교실 40권", price: "100,000원", location: "반포동동" },
      { image: popImg15, title: "업투 프리미엄 사당점 회원권 양도", price: "200,000원", location: "방배본동" },
      { image: popImg16, title: "오프화이트 멀티패치 빈티지 야상", price: "100,000원", location: "반포 1동" },
      { image: popImg17, title: "스투시 L사이즈 티셔츠", price: "19,000원", location: "반포동" },
      { image: popImg18, title: "데스커 W1100 화이트보드", price: "60,000원", location: "반포 2동" },
    ],
  },
  {
    id: '2', 
    ...
    sellerOtherProducts: [
      { image: popImg6, title: "새로운 판매자 상품 1", price: "20,000원", location: "강남" },
    ],
    category: "기타",
    timeAgo: "1분 전",
    price: "20,000원",
    ...
    popularListings: [
      { image: popImg1, title: "인기 상품 A", price: "12,000원", location: "동네 B" },
      { image: popImg3, title: "인기 상품 C", price: "30,000원", location: "동네 D" },
    ],
  },
  // ... 더 많은 상품 데이터 추가 가능
];
...
const ProductDetailsPage = () => {
  ...
  const { title, slides, sellerData, sellerOtherProducts, category, timeAgo, price, description, stats, popularListings } = product;
    ...
    <div className={style.productDetailsPage}>
      ...
      <div className={style.mainContent}>
        ...
        <div className={style.infoSection}>
          ...
          <button type="button" className={style.actionButton}>당근 앱에서 보기</button>
        </div>
      </div>

      <div className={style.sellerProductsSection}>
        <div className={style.sectionTitleContainer}>
          <h2 className={style.sectionTitle}>{sellerData.nickname} 님의 판매물품</h2>
         ...
         <div className={style.sellerProductsList}>
            {sellerOtherProducts.map((item, index) => (
             <div key={index} className={style.productCard}>
               ...
               <img src={item.image} alt={item.title} className={`${style.productImage} ${zoomStyle.image}`} />
               </div>
